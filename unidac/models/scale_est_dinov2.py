...
from unidac.models.backbones.metadinov2 import Attention, Mlp, SwiGLUFFN
from unidac.models.backbones.metadinov2.block import NestedTensorBlock
...
class ScaleMapEstimation(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.self_attn = NestedTensorBlock(
                        dim=self.embed_dim,
        ...
        if dino_state_dict is not None:
            self.self_attn.load_state_dict(dino_state_dict, strict=False)
